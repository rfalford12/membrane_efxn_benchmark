...
def run_heterodimer_docking_calc( energy_fxn, rosetta_exe_path, cluster_type, test_set, restore, implicit_lipids, aqueous_pore ):
    ...
    for case in test_cases:
        ...
        prepacked = inputs + "/" + test_set + "/" + case + "/" + case + ".prepack.pdb"
...
def main( args ):
    ...
    if ( "prediction" in test_types ): 
        ...
        #run_decoy_discrimination_calc( Options.energy_fxn, rosetta_exe_path, Options.cluster_type, restore, include_lipids, add_pore )
